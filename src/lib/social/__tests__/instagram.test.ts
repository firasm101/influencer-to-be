    ...
    it("should correctly map post types", async () => {
      mockedAxios.get.mockResolvedValueOnce({
        data: {
          ...
          data: {
            posts: [
              { socialPostID: "1", type: "carousel_album", text: "", likes: 0, comments: 0, rePosts: 0, date: "", er: 0 },
              { socialPostID: "2", type: "reel", text: "", likes: 0, comments: 0, rePosts: 0, date: "", er: 0 },
              { socialPostID: "3", type: "video", text: "", likes: 0, comments: 0, rePosts: 0, date: "", er: 0 },
              { socialPostID: "4", type: "image", text: "", likes: 0, comments: 0, rePosts: 0, date: "", er: 0 },
              { socialPostID: "5", type: "story", text: "", likes: 0, comments: 0, rePosts: 0, date: "", er: 0 },
            ],
          },
        },
      });
    ...
    it("should calculate engagement rate from API er value", async () => {
      mockedAxios.get.mockResolvedValueOnce({
        data: {
          ...
          data: {
            posts: [
              { socialPostID: "1", type: "image", text: "", likes: 100, comments: 10, rePosts: 0, date: "", er: 0.05 },
            ],
          },
        },
      });
